...
# cli:module pairs; macOS ships bash 3.2, so no associative arrays.
MODULES="ncua-pp-cli:$SRC/library/sales-and-crm/ncua
google-ads-transparency-pp-cli:$SRC/library/marketing/google-ads-transparency"

echo "$MODULES" | while IFS=: read -r cli module; do
